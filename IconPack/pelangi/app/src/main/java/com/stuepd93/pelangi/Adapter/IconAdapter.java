...
public class IconAdapter extends RecyclerView.Adapter<IconAdapter.SimpleItemViewHolder> {
    ...
    public IconAdapter(Context context, int arrayId) {
    ...
    @Override
    public IconAdapter.SimpleItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
