...
public class LauncherAdapter extends RecyclerView.Adapter<LauncherAdapter.SimpleItemViewHolder> {
    ...
    public LauncherAdapter(Context context, List<LauncherListItem> items, int installed) {
    ...
    @Override
    public LauncherAdapter.SimpleItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
